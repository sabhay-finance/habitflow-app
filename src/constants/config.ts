...
export const LEVEL_TIERS = [
  { level: 1, minXp: 0, title: 'Starting Out', icon: '🌱' },
  { level: 2, minXp: 100, title: 'Building Momentum', icon: '🌿' },
  { level: 3, minXp: 280, title: 'Consistent', icon: '⚡' },
  { level: 4, minXp: 550, title: 'Disciplined', icon: '🔥' },
  { level: 5, minXp: 950, title: 'Elite', icon: '🏆' },
  { level: 6, minXp: 1500, title: 'Flow Master', icon: '🌊' },
  { level: 7, minXp: 2250, title: 'Habit Architect', icon: '🏛️' },
  { level: 8, minXp: 3200, title: 'Unshakable Will', icon: '💎' },
  { level: 9, minXp: 4500, title: 'Zen Titan', icon: '🧘' },
...
export const STARTER_TEMPLATES = [
  {
    name: 'Drink Water',
    description: 'Stay hydrated with 2-3 liters for mental clarity and energy',
    emoji: '💧',
    color: 'cyan',
  ...
  {
    name: 'Read',
    description: 'Read 15-20 pages of a book to expand your mind daily',
    emoji: '📚',
    color: 'indigo',
  ...
  {
    name: 'Exercise',
    description: '30 minutes of intentional movement, lifting, or cardio',
    emoji: '🏋️',
    color: 'emerald',
  ...
  {
    name: 'Meditate',
    description: '10 minutes of mindfulness or breathwork to reset focus',
    emoji: '🧘',
    color: 'violet',
  ...
  {
    name: 'Sleep Early',
    description: 'Wind down screens by 10:30 PM for restorative recovery',
    emoji: '😴',
    color: 'amber',
    category: 'health' as HabitCategory,
    frequency: { type: 'daily' as const },
